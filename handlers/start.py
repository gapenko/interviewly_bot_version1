...
HELP_TEXT = (
    ...
    "интервьюер даёт краткую обратную связь, а следующий вопрос открывается кнопкой «➡️ Следующий вопрос».\n"
    "3. Под вопросом есть кнопки: подсказка, пропуск вопроса, начать заново, завершить досрочно.\n"
    "4. В конце вы получите итоговый разбор, черновик резюме и Word-отчёт, а также сможете "
    "просмотреть все свои ответы с комментариями интервьюера — всё это сохраняется "
